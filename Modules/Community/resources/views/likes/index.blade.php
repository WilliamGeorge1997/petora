...
@section('title', __('community::general.like.index'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('community::general.like.index') }}</h4>
                    </div>
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ __('community::general.like.index') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                var dt_basic = dt_basic_table.DataTable({
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                return data ? data.replace('Modules\\Community\\Models\\', '') : '-';
                            }
                        },
                        {
                            // Actions
                    ...
                    responsive: {
                        details: {
                            display: $.fn.dataTable.Responsive.display.modal({
                                header: function(row) {
                                    var data = row.data();
                                    return 'Details of Like ' + data['id'];
                                }
                            }),
                            type: 'column',
