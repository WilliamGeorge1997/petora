            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('country::general.cities') }}</h4>
                    </div>
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.dashboard') }}">{{ __('country::general.home') }}</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ __('country::general.cities') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-4 d-flex align-items-end">
                        ...
                        <a href="{{ route('admin.cities.index') }}"
                            class="btn btn-outline-secondary">{{ __('country::general.reset') }}</a>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <table class="datatables-basic table">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('country::attribute.country_id') }}</th>
    ...
    <script>
        $(function() {
            ...
            if (dt_basic_table.length) {
                var dt_basic = dt_basic_table.DataTable({
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            // Actions
                            targets: -1,
                            title: '{{ __('country::general.actions') }}',
                            orderable: false,
                            render: function(data, type, full, meta) {
                                return (
                ...
                $('div.head-label').html('<h6 class="mb-0">{{ __('country::general.cities') }}</h6>');
            }
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                var id = dt_basic.row($(this).parents('tr')).data().id;
                Swal.fire({
                    title: '{{ __('country::general.sure_delete') }}',
                    text: '{{ __('country::general.cant_revert') }}',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonText: '{{ __('country::general.yes_delete') }}',
                    cancelButtonText: '{{ __('country::general.cancel') }}',
                    customClass: {
