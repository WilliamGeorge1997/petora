    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">حالات الطلب</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">الرئيسية</a></li>
                            <li class="breadcrumb-item">البيانات الاساسية</li>
                            <li class="breadcrumb-item active">حالات الطلب</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog sidebar-sm">
                <form class="add-new-record modal-content pt-0" enctype="multipart/form-data" method="post">
                    ...
                    <div class="modal-body flex-grow-1">
                        ...
                        <div class="mb-1">
                            <label class="form-label" for="basic-icon-default-email">الايميل</label>
                        ...
                        <div class="mb-1">
                            <label class="form-label" for="basic-icon-default-post">كلمة المرور</label>
                            <input type="password" required id="basic-icon-default-post" class="form-control dt-password" placeholder="password" />
                        </div>

                        <div class="mb-1">
                            <label class="form-label" for="basic-icon-default-date">الصورة</label>
                       ...
                       <div class="mb-4">
                        ...
                        <button type="button" class="btn btn-primary data-submit me-1">اضافة</button>
                        <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal">الغاء</button>
                    </div>
                </form>
            </div>
        </div> --}}
...
@section('js')
    ...
    @if (session('updated'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم تعديل حالة الطلب بنجاح',
                icon: 'success',
                customClass: {
    ...
    @if (session('created'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء حالة الطلب بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
    ...
    <script>
        $(function() {
            ...
            if (dt_basic_table.length) {
                ...
                $('div.head-label').html('<h6 class="mb-0">حالات الطلب</h6>');
            }
