    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">طرق الطلب</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">الرئيسية</a></li>
                            <li class="breadcrumb-item">البيانات الاساسية</li>
                            <li class="breadcrumb-item active">طرق الطلب</li>
                        </ol>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    @if (session('updated'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم تعديل طريقة الطلب بنجاح',
                icon: 'success',
                customClass: {
    ...
    @if (session('created'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء طريقة الطلب بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
    ...
    <script>
        $(function() {
            ...
            if (dt_basic_table.length) {
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                if ($user_img) {
                                    // $user_img = window.location.origin+'/uploads/ordermethod/'+$user_img;
                                    // For Avatar image
                                    var $output =
                                        '<img src="' + $user_img +
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return (
                                    ...
                                    @can('Edit-ordermethod')
                                        +
                                        '<a href="ordermethods/activate/' + data +
                                            '" class="dropdown-item">' +
                        ...
                        @can('Create-ordermethod')
                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    window.location.href = './ordermethods/create';
                                },
                ...
                $('div.head-label').html('<h6 class="mb-0">طرق الطلب</h6>');
            }
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: window.location.origin + "/admin/ordermethods/" + id,
                            type: 'POST',
                            data: {
                                "id": id,
                                "_method": "DELETE",
