...
class ClinicRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'working_hours.*.day' => ['required_with:working_hours', 'string', Rule::in(WeekDay::values()), 'distinct'],
            'working_hours.*.is_open_24_hours' => ['sometimes', 'nullable'],
    ...
    public function messages()
    {
        return [
            ...
            'working_hours.*.day.required_with' => __('clinic::message.day_required'),
            'working_hours.*.day.required' => __('clinic::message.day_required'),
            'working_hours.*.day.string' => __('clinic::message.day_string'),
            'working_hours.*.day.in' => __('clinic::message.day_in'),
            'working_hours.*.day.distinct' => __('clinic::message.day_distinct'),
            'working_hours.*.from.date_format' => __('clinic::message.from_date_format'),
            'working_hours.*.to.date_format' => __('clinic::message.to_date_format'),
        ];
    }
}
