...
@section('title', __('clinic::general.delivery_schedule.edit'))
...
@section('content')
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.clinic.delivery-schedules.update', [$clinic->id, $schedule->id]) }}" method="POST">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <button type="submit" class="btn btn-primary me-1"><i data-feather="save" class="me-50"></i>{{ __('clinic::general.update') }}</button>
