...
@section('title', __('community::general.post.index'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('community::general.post.index') }}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                return (
                                    ...
                                    @can('Edit-post')
                                        +
                                        '<a href="posts/' + data + '" class="dropdown-item">' +
                    ...
                    responsive: {
                        details: {
                            display: $.fn.dataTable.Responsive.display.modal({
                                header: function(row) {
                                    var data = row.data();
                                    return 'Details of Post ' + data['id'];
                                }
                            }),
                            type: 'column',
