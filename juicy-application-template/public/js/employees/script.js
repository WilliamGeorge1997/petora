        ...
        var dt_basic = dt_basic_table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        var $user_img = full['image'],
                            ...
                            $email = full['email'];
                        if ($user_img) {
                             $user_img = window.location.origin+'/uploads/employee/'+$user_img;
                            // For Avatar image
                            var $output =
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        var $status = {
                            1: { title: 'Cashier', class: 'badge-light-info' },
                            2: { title: 'Kitchen', class: ' badge-light-warning' },
                        };
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return (
                            ...
                            '<a href="employees/activate/'+data+'" class="dropdown-item">' +
                            ...
                            '</div>' +
                            '</div>' +
                            '<a href="employees/'+data+'/edit" class="item-edit">' +
