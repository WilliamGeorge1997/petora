...
@section('title', __('clinic::general.schedule.add'))
...
@section('content')
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.clinic.services.schedules.store', [$clinic->id, $clinicService->id]) }}" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <button type="submit" class="btn btn-primary me-1"><i data-feather="plus" class="me-50"></i>{{ __('clinic::general.schedule.add') }}</button>
                        </div>
                    </div>
                </form>
            </div>
