...
@section('content')
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal invoice-repeater" action="{{ url('admin/sides/' . $side['id']) }}"
                    ...
                    <div class="row">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" value="{{ $side->getTranslations('title')['ar'] }}"
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" value="{{ $side->getTranslations('title')['en'] }}"
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" value="{{ $side->getTranslations('display')['ar'] ?? '' }}"
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" value="{{ $side->getTranslations('display')['en'] ?? '' }}"
                                            ...
                                            <select class="select2 form-select" id="branch-select" name="branch_id">
                                                @foreach (\Modules\Branch\Entities\Branch::active()->get() as $branch)
                                                    <option value="{{ $branch->id }}"
                                                        @if ($side['branch_id'] == $branch->id) selected @endif>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="number" value="{{ $side->max_selection }}" id="fname-icon"
                                            class="form-control" name="max_selection" placeholder="اقصي عدد للاختيارات" />
                                        @error('max_selection')
                                            <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <div class="mb-1">
                                <div class="form-check">
                                    <input type="checkbox" @if ($side['is_active'] == 1) checked @endif value="1"
                        ...
                        <div class="divider divider-primary">
                            <div class="divider-text">قيم الاطباق الجانبية</div>
                        </div>

                        <div data-repeater-list="side_values">
                            @foreach ($side['values'] as $value)
                                <div data-repeater-item>
                                    <div class="row d-flex align-items-center">
                                        <div class="col-md-3 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="itemname">قيمة الطبق الجانبي باللغة
                                                    العربية</label>
                                                <input type="text" value="{{ $value['title'] }}" name="value_ar"
                                                    class="form-control" id="itemname" aria-describedby="itemname"
                                                    placeholder="قيمة الطبق الجانبي باللغة العربية" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="itemname">قيمة الطبق الجانبي باللغة
                                                    الانجليزية</label>
                                                <input type="text" value="{{ $value->getTranslations('title')['en'] }}"
                                                    name="value_en" class="form-control" id="itemname"
                                                    aria-describedby="itemname"
                                                    placeholder="قيمة الطبق الجانبي باللغة الانجليزية" />
                                            </div>
                                        </div>

                                        <div class="col-md-2 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="itemquantity">الصورة الطبق الجانبي </label>
