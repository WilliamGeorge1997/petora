...
@section('title', __('order::general.index'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('order::general.payment_methods') }}</h4>
                    </div>
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ __('order::general.payment_methods') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
@section('js')
    ...
    <script>
        $(function() {
            ...
            var ajaxRequest = "payment-methods?";
                        ...
                        @can('Create-paymentmethod')
                            {
                                ...
                                }) + '{{ __('order::general.create_payment_method') }}',
                                className: 'create-new btn btn-primary',
                                action: function(e, dt, node, config) {
                                    window.location.href = './payment-methods/create';
                                },
            ...
            $('.datatables-basic tbody').on('change', '.change-status', function() {
                ...
                $.ajax({
                    url: '/admin/payment-methods/' + id + '/activate',
                    type: 'PATCH',
                    data: {
                        _token: token
                    }
