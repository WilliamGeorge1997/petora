...
@section('js')
    ...
    @if (session('updated'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم تعديل الطبق الجانبي بنجاح',
                icon: 'success',
                customClass: {
    ...
    @if (session('created'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء الطبق الجانبي بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
        ...
        $(function() {
            ...
            if (dt_basic_table.length) {
                var dt_basic = dt_basic_table.DataTable({
                    ...
                    buttons: [{
                        ...
                        @can('Edit-side')
                            {
                                text: 'ترتيب الاطباق الجانبية',
                                className: 'btn btn-primary me-1',
                                action: function(e, dt, node, config) {
                                    window.location.href = './sides/sort';
                                },
                                init: function(api, node, config) {
                                    $(node).removeClass('btn-secondary');
                                }
                        ...
                        @can('Create-product')
...

                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    window.location.href = './sides/create';
                                },
                                init: function(api, node, config) {
                                    $(node).removeClass('btn-secondary');
                                }
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        url: window.location.origin + "/admin/sides/" + id,
                        type: 'POST',
                        data: {
                            "id": id,
                            "_method": "DELETE",
