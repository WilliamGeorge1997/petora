...
@section('title', __('community::general.hashtag.index'))
...
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('community::general.hashtag.index') }}</h4>
                    </div>
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ __('community::general.hashtag.index') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="card mb-2">
        <div class="card-body">
            <form>
                <div class="row g-2">
                    <div class="col-md-4">
                        <label class="form-label">{{ __('community::attribute.text') }}</label>
                        <input type="text" name="text" class="form-control"
                            placeholder="{{ __('community::attribute.text') }}" value="{{ request('text') }}">
                    </div>
                    <div class="col-md-3">
                    ...
                    <table class="datatables-basic table">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('community::attribute.text') }}</th>
    ...
    <!--/ Basic table -->
    {{ $hashtags->withQueryString()->links() }}
@endsection
...
@section('js')
    ...
    <script>
        $(function() {
            ...
            var ajaxRequest = "hashtags?";
            if (page != null) ajaxRequest += "page=" + page + '&';
            if (text != null) ajaxRequest += "text=" + text + '&';
            ...
            $('.datatables-basic tbody').on('change', '.change-status', function() {
                ...
                $.ajax({
                    url: '/admin/hashtags/' + id + '/activate',
                    type: 'PATCH',
                    data: {
                        _token: token
                    }
