    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('order::general.edit_payment_method') }} {{ $paymentMethod->getTranslation('title', 'ar') }}</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.payment_method.update', $paymentMethod->id) }}" method="POST">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div class="row">
                        {{-- Title ar --}}
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="title_en"
                                            value="{{ $paymentMethod->getTranslation('title', 'en') }}" class="form-control"
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <div class="mb-1">
                                <div class="form-check">
                                    <input type="checkbox" value="1" {{ old('is_active', $paymentMethod->is_active) ? 'checked' : '' }}
                        ...
                        {{-- Submit Button --}}
                        <div class="col-sm-9 offset-sm-3">
                            <button type="submit" class="btn btn-primary me-1"><i data-feather="edit" class="me-50"></i>{{ __('order::general.edit_payment_method') }}</button>
                        </div>
                    </div>
                </form>
            </div>
