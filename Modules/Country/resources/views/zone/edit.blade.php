...
@section('title', __('country::general.edit_zone'))
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('country::general.edit_zone') }} {{ $zone->getTranslation('title', 'ar') }}</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.zones.update', $zone->id) }}" method="POST"
                    ...
                    <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="title_ar"
                                            value="{{ $zone->getTranslation('title', 'ar') }}" class="form-control"
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="title_en"
                                            value="{{ $zone->getTranslation('title', 'en') }}" class="form-control"
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                <div class="col-sm-3 text-center">
                                    <label class="col-form-label"
                                        for="city_id">{{ __('country::attribute.city_id') }}</label>
                                </div>
                                <div class="col-sm-9">
                                    <select class="select2 form-select" name="city_id" id="city_id" required>
                                        <option value="" disabled selected>{{ __('country::general.select_city') }}
                                        </option>
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <div class="mb-1">
                                <div class="form-check">
                                    <input type="checkbox" value="1" @if ($zone->is_active == 1) checked @endif
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <button type="submit" class="btn btn-primary me-1"><i data-feather="edit"
                                    class="me-50"></i>{{ __('country::general.edit_zone') }}</button>
                        </div>
                    </div>
                </form>
            </div>
