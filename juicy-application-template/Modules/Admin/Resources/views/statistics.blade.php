...
@section('content')
    ...
    <section id="dashboard-ecommerce">
            ...
            <div class="col-xl-4 col-md-6 col-12">
                <div class="card card-congratulation-medal">
                    <div class="card-body">
                        ...
                        <p class="card-text font-small-3">اهلا بك في نظام ادارة فرعك <span
                                class="badge bg-primary">{{ $admin->branch?->getTranslations('title')['ar'] ?? '' }}</span>
                        </p>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0">{{ $ordersBaseCount }}</h4>
                            ...
                            <div class="col-xl-3 col-sm-6 col-12">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0">{{ $ordersBaseSum }}</h4>
                            ...
                            @if ($admin->hasRole('Branch Manager'))
                                <div class="col-xl-3 col-sm-6 col-12">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h4 class="fw-bolder mb-0">{{ (int) $admin->branch?->scan_counter ?? 0 }}</h4>
                                            <p class="card-text font-small-3 mb-0">زيارات المنيو</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
        ...
        <div class="row match-height">
            <div class="{{ (isset($activeSubscription) && $activeSubscription->product_count) ? 'col-lg-8' : 'col-lg-4' }} col-12">
                <div class="row match-height">
                    <!-- Bar Chart - Orders -->
                    <div class="col-lg-6 col-md-3 col-6">
                        <div class="card">
                            <div class="card-body pb-50">
                                ...
                                <h2 class="fw-bolder mb-1">{{ $currentMonthOrdersCount }}</h2>
                    ...
                    <div class="col-lg-6 col-md-3 col-6">
                        <div class="card card-tiny-line-stats">
                            <div class="card-body pb-50">
                                ...
                                <h2 class="fw-bolder mb-1">{{ $currentMonthOrdersSum }} جنية</h2>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <h5 class="mb-1">{{ (int) $lastMonthOrders->sum('total') }} جنية مصري</h5>
            ...
            @if(isset($activeSubscription) && $activeSubscription->product_count)
            <!-- Product Limit Chart -->
            <div class="col-lg-4 col-12">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center pb-0">
                        <h4 class="card-title">المنتجات المسموح بها</h4>
                    </div>
                    <div class="card-body">
                        <div id="product-limit-chart" class="mb-1"></div>
                        <div class="text-center mt-1">
                            <p class="mb-0 font-small-3">المنتجات الحالية: <span class="fw-bolder">{{ $currentProductCount }}</span> من <span class="fw-bolder">{{ $activeSubscription->product_count }}</span></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="{{ (isset($activeSubscription) && $activeSubscription->product_count) ? 'col-12' : 'col-lg-8 col-12' }}">
...
@section('js')
    ...
    $(window).on('load', function() {
        var percentage = {{ ($currentProductCount / $activeSubscription->product_count) * 100 }};
        ...
        var options = {
            ...
            colors: [percentage >= 100 ? '#ea5455' : '#7367f0'],
            plotOptions: {
                radialBar: {
                    offsetY: -10,
                    startAngle: -90,
            ...
            fill: {
                ...
                gradient: {
                    ...
                    type: 'horizontal',
                    shadeIntensity: 0.5,
                    gradientToColors: [percentage >= 100 ? '#ea5455' : '#28c76f'],
                    inverseColors: true,
                    opacityFrom: 1,
                    opacityTo: 1,
                    stops: [0, 100]
        ...
        var chart = new ApexCharts(document.querySelector("#product-limit-chart"), options);
        chart.render();
    });
    </script>
    @endif
