            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('store::general.stores') }}</h4>
                    </div>
                    <div class="card-body">
                    ...
                    <table class="datatables-basic table">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('store::attribute.phone') }}</th>
                                <th>{{ __('store::attribute.created_at') }}</th>
    ...
    <script>
        $(function() {
            ...
            if (dt_basic_table.length) {
                ...
                $('div.head-label').html('<h6 class="mb-0">{{ __('store::general.main_data') }}</h6>');
            }
