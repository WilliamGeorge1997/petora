...
@section('title', __('category::general.create'))

@section('content')
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('category::general.create') }}</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.category.store') }}" method="POST"
                    ...
                    <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="title_ar" required
                                            placeholder="{{ __('category::attribute.title_ar') }}"
                                            value="{{ old('title_ar') }}" />
                                    </div>
                                    @error('title_ar')
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="title_en" required
                                            placeholder="{{ __('category::attribute.title_en') }}"
                                            value="{{ old('title_en') }}" />
                                    </div>
                                    @error('title_en')
                                        <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <button type="submit"
                                class="btn btn-primary me-1"><i data-feather="plus" class="me-50"></i>{{ __('category::general.create') }}</button>
                        </div>
                    </div>
                </form>
            </div>
