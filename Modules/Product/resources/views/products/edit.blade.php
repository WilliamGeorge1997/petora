                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="title_ar" required
                                            ...
                                            value="{{ old('title_ar', $product->getTranslation('title', 'ar', false)) }}" />
                                    </div>
                                    @error('title_ar')
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <textarea class="form-control" name="description_ar" placeholder="{{ __('product::attribute.description_ar') }}">{{ old('description_ar', $product->getTranslation('description', 'ar', false)) }}</textarea>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="file-text"></i></span>
                                        <textarea class="form-control" name="description_en" placeholder="{{ __('product::attribute.description_en') }}">{{ old('description_en', $product->getTranslation('description', 'en', false)) }}</textarea>
                                    </div>
                            ...
                            <div class="mb-1">
                                <div class="form-check">
                                    <input type="checkbox" value="1" name="is_active" class="form-check-input"
                                        id="customCheck2" {{ $product->is_active ? 'checked' : '' }} />
