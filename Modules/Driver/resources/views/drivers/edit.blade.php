...
@section('title', __('driver::general.edit'))
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('driver::general.edit') }}</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.driver.update', $driver) }}" method="POST"
                    ...
                    <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" required
                                            placeholder="{{ __('driver::attribute.name') }}"
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="password" class="form-control" name="password" id="password"
                                            placeholder="{{ __('driver::attribute.password') }} ({{ __('common::general.leave_blank_to_keep') ?? 'اتركه فارغاً للإبقاء عليه' }})" />
                                    </div>
                                    @error('password')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="license_id" id="license_id"
                                            ...
                                            value="{{ old('license_id', $driver->license_id) }}" />
                                    </div>
                                    @error('license_id')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                    ...
                                    <select class="form-select select2" name="store_id" id="store_id">
                                        ...
                                        @foreach ($viewModel->stores() as $store)
                                            <option value="{{ $store->id }}"
                                                {{ old('store_id', $driver->store_id) == $store->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-select select2" name="clinic_id" id="clinic_id">
                                        ...
                                        @foreach ($viewModel->clinics() as $clinic)
                                            <option value="{{ $clinic->id }}"
                                                {{ old('clinic_id', $driver->clinic_id) == $clinic->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-select select2" name="country_id" id="country_id"
                                        ...
                                        @foreach ($viewModel->countries() as $country)
                                            <option value="{{ $country->id }}"
                                                {{ old('country_id', $driver->country_id) == $country->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-select select2" name="city_id" id="city_id"
                                        ...
                                        @if ($driver->city)
                                            <option value="{{ $driver->city->id }}" selected>
                                                {{ $driver->city->getTranslation('title', $locale) }}
                                            </option>
                                        @else
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select select2" name="zone_id" id="zone_id">
                                        @if ($driver->zone)
                                            <option value="{{ $driver->zone->id }}" selected>
                                                {{ $driver->zone->getTranslation('title', $locale) }}
                                            </option>
                                        @else
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <button type="submit" class="btn btn-primary me-1">{{ __('driver::general.edit') }}</button>
