...
@section('title', __('order::general.order_statuses'))
...
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('order::general.order_statuses') }}</h4>
                    </div>
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ __('order::general.order_statuses') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <!--/ Basic table -->
    {{ $orderStatuses->withQueryString()->links() }}
@endsection
...
@section('js')
    ...
    <script>
        $(function() {
            ...
            var ajaxRequest = "order-statuses?";
                        ...
                        @can('Create-orderstatus')
                            {
                                ...
                                }) + '{{ __('order::general.create_order_status') }}',
                                className: 'create-new btn btn-primary',
                                action: function(e, dt, node, config) {
                                    window.location.href = './order-statuses/create';
                                },
            ...
            $('.datatables-basic tbody').on('change', '.change-status', function() {
                ...
                $.ajax({
                    url: '/admin/order-statuses/' + id + '/activate',
                    type: 'PATCH',
                    data: {
                        _token: token
                    }
