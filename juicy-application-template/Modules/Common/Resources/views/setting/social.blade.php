...
@section('css')
    ...
    <style>
        #cke_notifications_area_validationBioBootstrap {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">تعديل اعدادت السوشيال ميديا</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ url('admin/setting') }}" method="POST"
                    ...
                    <div class="row">
                        @foreach ($settings as $setting)
                            @if ($setting->type != 'textarea' && $setting->type != 'file')
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        <div class="col-sm-3 text-center">
                                            <label class="col-form-label"
                                                   for="fname-icon"> {{ $setting->display }}</label>
                                        </div>
                                        <div class="col-sm-9">
                            ...
                            @else
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group input-group-merge">
                                                <textarea class="form-control" id="validationBioBootstrap" minlength="6"
                                                          name="{{ $setting->key }}" rows="20"
                                                          style="direction: rtl !important;">{{ @optional($setting)->value }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
