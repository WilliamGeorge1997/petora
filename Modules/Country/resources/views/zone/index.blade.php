...
@section('title', __('country::general.index_zone'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('country::general.zones') }}</h4>
                    </div>
                    <div class="card-body">
                    ...
                    <table class="datatables-basic table">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('country::attribute.city_id') }}</th>
