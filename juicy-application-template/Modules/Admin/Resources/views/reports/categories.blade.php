    ...
    <div class="card">
        <div
            ...
            <div class="header-left">
                <h4 class="card-title">اكثر الاقسام مبيعا علي مدار العام</h4>
            </div>
        </div>
                    ...
                    <div style="margin-top: 5%" class="col-md-3">
                        ...
                        <select name="branch" class="form-select" id="name5">
                            ...
                            @foreach ($Branches as $Branch)
                                <option @if ($Branch['id'] == @$_GET['branch']) selected @endif value="{{ $Branch['id'] }}">
                                    {{ $Branch['title'] }}</option>
                            @endforeach
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">تقارير الاقسام الاعلي مبيعاً</h4>
                    </div>
                    <a href="{{ url("export-categoryreport/xlsx?$Parameters") }}"> <button type="button"
                            style="float:left" class="btn btn-outline-primary ">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($categoriesreport as $categories)
                                    <tr>
                                        <td>
                                            <span class="fw-bold">{{ $categories['title'] }}</span>
                                        </td>
                                        <td>{{ (int) $categories['order_details_count'] }}</td>
                                        <td>{{ (int) $categories['order_details_sum_total'] }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
