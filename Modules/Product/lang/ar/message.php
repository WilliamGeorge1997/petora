...
return [
    ...
    'fetched' => 'تم جلب المنتجات بنجاح.',
    'activated' => 'تم التفعيل بنجاح.',
    'deactivated' => 'تم الإلغاء بنجاح.',

    'category_id_required' => 'القسم مطلوب.',
    'category_id_exists' => 'القسم المحدد غير صالح.',

    'title_en_required' => 'الاسم بالانجليزية مطلوب.',
    'title_en_string' => 'الاسم بالانجليزية يجب ان يكون نص.',
    'title_ar_required' => 'الاسم بالعربية مطلوب.',
    'title_ar_string' => 'الاسم بالعربية يجب ان يكون نص.',
