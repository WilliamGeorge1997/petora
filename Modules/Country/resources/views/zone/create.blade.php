...
@section('title', __('country::general.create_zone'))
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('country::general.create_zone') }}</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.zones.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <button type="submit"
                                class="btn btn-primary me-1"><i data-feather="plus" class="me-50"></i>{{ __('country::general.create_zone') }}</button>
                        </div>
                    </div>
                </form>
            </div>
