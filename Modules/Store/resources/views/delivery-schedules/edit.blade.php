...
@section('title', __('store::general.delivery_schedule.edit'))
...
@section('content')
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.store.delivery-schedules.update', [$store->id, $schedule->id]) }}" method="POST">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div class="row">
                            ...
                            <div class="mb-1 row">
                                <div class="col-sm-3 text-center">
                                    <label class="col-form-label" for="daySelect">
                                        {{ __('store::general.day') }} <span class="text-danger">*</span>
                                    </label>
                                </div>
                                <div class="col-sm-9">
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <button type="submit" class="btn btn-primary me-1"><i data-feather="save" class="me-50"></i>{{ __('store::general.update') }}</button>
