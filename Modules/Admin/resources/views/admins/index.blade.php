...
@section('content')
    ...
    {{-- Pagination --}}
    <div class="d-flex justify-content-between align-items-center mx-0 row mt-1">
        <div class="col-sm-12 col-md-6" id="table-info-target"></div>
        <div class="col-sm-12 col-md-6 d-flex justify-content-md-end" id="table-pagination-target"></div>
    </div>
    {{-- Pagination --}}
@endsection
        ...
        $(function() {
            ...
            if (dt_basic_table.length) {
                var dt_basic = dt_basic_table.DataTable({
                    ...
                    dom: '<"card-header border-bottom p-1"<"head-label"><"dt-action-buttons text-end"B>><"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-none"ip>',
                    displayLength: 50,
                    ...
                    drawCallback: function(settings) {
                        $('#table-pagination-target').empty().append($('.dataTables_paginate'));
                        $('#table-info-target').empty().append($('.dataTables_info'));
                    }
                });
