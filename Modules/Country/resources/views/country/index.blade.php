...
@section('title', __('country::general.index'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('country::general.countries') }}</h4>
                    </div>
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ __('country::general.countries') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <script>
        $(function() {
            ...
            $('.datatables-basic tbody').on('change', '.change-status', function() {
                ...
                $.ajax({
                    url: '/admin/countries/' + id + '/activate',
                    type: 'PATCH',
                    data: {
                        _token: token
                    }
