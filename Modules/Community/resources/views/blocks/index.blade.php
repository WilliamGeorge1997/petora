...
@section('title', __('community::general.block.index'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('community::general.block.index') }}</h4>
                    </div>
                    <div class="card-body">
                    ...
                    responsive: {
                        details: {
                            display: $.fn.dataTable.Responsive.display.modal({
                                header: function(row) {
                                    var data = row.data();
                                    return 'Details of Block ' + data['id'];
                                }
                            }),
                            type: 'column',
